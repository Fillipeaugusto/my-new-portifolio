	...
	const cards = [
		{
			...
			link:
				'https://www.linkedin.com/redir/redirect?url=https%3A%2F%2Fwww%2Eudemy%2Ecom%2Fcertificate%2FUC-416a2a73-0f3c-4aaa-b35c-8f5c97e08ae0%2F&urlhash=hcG2&trk=public_profile_see-credential',
		},
		{
				...
				{cards.map((card, i) =>
					card.link ? (
						<Link href={card.link} key={i} passHref>
							<div className="md:w-1/2 lg:w-1/3 px-6 flex cursor-pointer">
						...
						<div className="md:w-1/2 lg:w-1/3 px-6 flex ">
							<div className="flex flex-col mx-auto max-w-xs items-center px-6 py-10 border-2 border-dashed border-violet-600 rounded-lg mt-12">
								<span className="border-2 border-gray-300 text-center rounded-full p-6 flex-shrink-0 relative">
									<svg
										xmlns="http://www.w3.org/2000/svg"
